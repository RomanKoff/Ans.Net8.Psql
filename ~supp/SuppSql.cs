...
namespace Ans.Net8.Psql
{
	...
	public static class SuppSql
	{
		 ...
		 * string GetValue(DateTime? value);
		 * string GetValue(DateOnly value);
		 * string GetValue(DateOnly? value);
		 * string GetValue(TimeOnly value);
		 * string GetValue(TimeOnly? value);
		 ...
		 * string GetValueAsDateOnlyOrNULL(object value);
		 * string GetValueAsTimeOnlyOrNULL(object value);
			...
			object value)
		{
			if (value == null)
				return "NULL";
			return GetValue(value.ToString().ToDateOnly());
		}
			...
			object value)
		{
			if (value == null)
				return "NULL";
			return GetValue(value.ToString().ToTimeOnly());
		}
